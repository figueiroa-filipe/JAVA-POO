...
public class Person {
    ...
    public String toString() {
        String sex = (getSex() == Sex.MALE)? "m" : "f";
        // Formatar a data no formato desejado
        SimpleDateFormat formatoSaida = new SimpleDateFormat("MMM dd yyyy");
        String dataFormatada = formatoSaida.format(getBirthDate());
        return getName() + " " + sex + " " + dataFormatada;
    }
}
